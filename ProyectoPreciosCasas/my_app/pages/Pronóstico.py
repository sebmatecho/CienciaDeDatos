...
mLink = 'https://github.com/sebmatecho/CienciaDeDatos/blob/master/ProyectoPreciosCasas/parameters/bathrooms.sav'
# mfile = BytesIO(requests.get(mLink).content)
# scaler = joblib.load(mfile)

 
myfile = requests.get(mLink)
scaler = BytesIO(myfile.content)
pickle.load(scaler)

# scaler = joblib.load('https://raw.githubusercontent.com/sebmatecho/CienciaDeDatos/master/ProyectoPreciosCasas/parameters/bathrooms.sav')
